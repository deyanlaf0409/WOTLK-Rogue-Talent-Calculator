...
class AssassinationGUI:
    def __init__(self, parent):
        ...
        self.image_1 = ImageTk.PhotoImage(Image.open(self.path + "ability_rogue_eviscerate.jpg"))
        self.image_2 = ImageTk.PhotoImage(Image.open(self.path + "ability_fiegndead.jpg"))
        self.image_3 = ImageTk.PhotoImage(Image.open(self.path + "ability_racial_bloodrage.jpg"))
        self.image_4 = ImageTk.PhotoImage(Image.open(self.path + "ability_druid_disembowel.jpg"))
        self.image_5 = ImageTk.PhotoImage(Image.open(self.path + "ability_rogue_bloodsplatter.jpg"))
        self.image_6 = ImageTk.PhotoImage(Image.open(self.path + "ability_backstab.jpg"))
